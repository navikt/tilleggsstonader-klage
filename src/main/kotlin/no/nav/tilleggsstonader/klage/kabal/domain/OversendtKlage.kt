...
enum class Type(
    ...
    OMGJOERINGSKRAV("Omgjøringskrav"),
    BEHANDLING_ETTER_TRYGDERETTEN_OPPHEVET("Behandling etter Trygderetten opphevet"),
    BEGJAERING_OM_GJENOPPTAK("Begjæring om gjenopptak"),
}
...
enum class LovKilde(
    ...
    OVERGANGSFORSKRIFTEN("60", "Overgangsforskriften", "Lov om endringer i folketrygdloven (delvis avvikling av stønad til enslig mor eller far)"),
